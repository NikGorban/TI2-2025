document.addEventListener('DOMContentLoaded', function (){
    ...
    const regexPortable = /^04\d{8}$/;
        ...
        btn.addEventListener('click', function (e) {
            ...
            const inputprenom = document.getElementById("firstname").value.trim();
            const inputnom = document.getElementById("lastname").value.trim();
            const inputemail = document.getElementById("usermail").value.trim();
            const inputpostal = document.getElementById("postcode").value.trim();
            const inputportable = document.getElementById("phone").value.trim();
